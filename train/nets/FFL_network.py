...
if __name__ == '__main__':
    # FFL
    ffl_resnet = FFL_ResNet(depth=32, num_classes=100)
    data = torch.rand((4, 3, 32, 32))
    x_3_1, x_3_2, fmap = ffl_resnet(data)
    print(x_3_1.shape)
    print(x_3_2.shape)
    print(len(fmap))
    print(fmap[0].shape)
    ...
    # Fusion Model
    fusion_module = Fusion_module(64, 100, 8)
    fusion_output = fusion_module(fmap[0], fmap[1])
