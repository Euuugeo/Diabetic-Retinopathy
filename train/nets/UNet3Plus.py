...
class UNet3Plus_DeepSup(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return F.sigmoid(d1).permute(0, 2, 3, 1), F.sigmoid(d2).permute(0, 2, 3, 1) \
...
if __name__ == '__main__':
    model = UNet3Plus_DeepSup(3, 5)
    input_tensor = torch.rand(1, 3, 640, 640)
    d1, d2, d3, d4, d5 = model(input_tensor)
