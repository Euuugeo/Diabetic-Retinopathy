...
from DataSet import load_ddr_train_val
...
if __name__ == '__main__':
    ...
    tasks = ['EX', 'MA', 'HE', 'SE']
    model_type = 'unet'
    #checkpoints_path = '/root/autodl-tmp/LKD/single_network_log/mcaunetmodels/Test_session_04.20 12h43/model.LBTW_WeightedDiceBCE--mcaunet--149.pth.tar'  # Renamed variable to be clearer
    checkpoints_path = '/root/autodl-tmp/LKD/student/models/Test_session_04.25 11h03/model.LBTW_WeightedDiceBCE--mcaunet--47.pth.tar'  # Renamed variable to be clearer
    n_labels = len(tasks) + 1
    n_channels = 3 

    train_loader, val_loader = load_ddr_train_val(batch_size=1)
    ...
    checkpoints = torch.load(checkpoints_path, map_location=device)  # Fixed this line
